...
urlpatterns = [
    ...
    path("drug/fetch/", SaveDrugDataView.as_view(), name="fetch_and_save"),  # 의약품 정보 업데이트 예) 전체보기: api/drug, Search: api/drug/?search=195500005, api/drug/?search=타이레놀
    ...
    path("drug_appearance/fetch/", SaveAppearanceDataView.as_view(), name="fetch_appearance_data"),  # 외형 정보 업데이트
